...
Protozoan sits between the developer and their existing dev server as a transparent proxy. It injects a thin client SDK into every HTML response, which powers the overlay UI. All AI and annotation logic runs server-side; the client is kept as lightweight as possible.
